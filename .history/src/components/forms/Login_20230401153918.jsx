          ...
          <Form className="shadow-2xl w-96 mx-3 sm:mx-0 sm:w-4/5 md:w-4/6 lg:w-4/5 xl:w-1/2 flex flex-col items-center bg-white p-5 md:py-10 rounded-tl-3xl rounded-br-3xl">
            ...
            <section className="py-7 space-y-6">
              ...
              <div className="sm:w-96 border border-[rgb(240,72,88)] space-x-4 flex items-center w-64  p-2 " style={{width : '100%'}}>
                ...
                >
                  {pass ? <i className="fa-sharp fa-solid fa-eye-slash"  style={{fontSize : '20px'}}></i>:  <i className="fa-solid fa-eye" style={{fontSize : '20px'}} ></i>}
                </span>
              </div>
              <button
                type="submit"
              ...
              >
                {loading ? (
                  ...
                  <div style={{display : 'flex' , alignItems : 'center' , gap : '10px' }}>
                    ...
                    <i className="fa-solid fa-right-to-bracket" style={{ color: "#fff"  , fontSize : '20px'}} ></i>
              ...
              <button
                ...
                className="py-2 cursor-pointer tracking-wider bg-[rgb(85,51,255)] flex justify-center items-center w-full rounded-full font-medium"
                style={{ color: "#fff"  , fontSize : '20px'}}
              >
                Vendor Login
              </button>
