...
const Login = () => {
  ...
  return (
    <>
      <div className="w-full h-screen flex flex-col justify-center items-center " style={{backgroundColor : '#6610f2'}}>
        ...
        >
          <Form className="shadow-2xl w-96 mx-3 sm:mx-0 sm:w-4/5 md:w-4/6 lg:w-4/5 xl:w-1/2 flex flex-col items-center p-5 md:py-10 rounded-tl-3xl rounded-br-3xl">
          <Alert >No Admin exists with the provided Email  </Alert>
            <span
