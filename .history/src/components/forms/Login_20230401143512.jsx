...
const Login = () => {
  ...
  const login = async (values) => {
    setLoading(true);
    const url = "https://b7w3czz0m2.execute-api.ap-south-1.amazonaws.com/development/api/admin/login";
    try {
  ...
  return (
    <>
      <div className="w-full h-screen flex flex-col justify-center items-center bg-slate-100">
          ...
          <form className="shadow-2xl w-96 mx-3 sm:mx-0 sm:w-4/5 md:w-4/6 lg:w-4/5 xl:w-1/2 flex flex-col items-center bg-white p-5 md:py-10 rounded-tl-3xl rounded-br-3xl" onSubmit={login}>
