          ...
          <div
            className={
              hamb
                ...
                : "  class=" md:w-72 z-30 bg-slate-200  shadow-md  md:static absolute top-0 -left-full   transition-all duration-150  overflow-y-auto h-auto" "
            }
            style={{backgroundColor : "#263544" , width : '300px'}}
          >
