...
const Dishes = () => {
  ...
  const deleteHandeler = async (id) => {
    try{
      const { data } = await axios.delete(`https://b7w3czz0m2.execute-api.ap-south-1.amazonaws.com/development/api/deleteDishesByAdmin/${id}`)
      console.log(data)
      alert('Deleted')
      fetchDishes()
    }catch(e) { 
