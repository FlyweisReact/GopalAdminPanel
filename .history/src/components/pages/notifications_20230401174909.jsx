...
const Notification = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const postHandler = async(e) => {
      e.preventDefault()
      try{
        const { data } = await axios.post("https://b7w3czz0m2.execute-api.ap-south-1.amazonaws.com/development/api/sendNotificationsByAdmin" , {message})
        console.log(data)
        props.onHide()
        alert('Added')
        fetchDishes()
      ...
      >
       ...
       <Form onSubmit={postHandler}>
          <Form.Group className="mb-3">
            ...
            <Form.Control type='text'onChange={(e) => setM(e.target.value)} />
          </Form.Group>
       </Form>
        </Modal.Body>
      </Modal>
