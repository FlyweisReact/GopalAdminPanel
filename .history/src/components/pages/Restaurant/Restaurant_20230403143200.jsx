  ...
  return (
    <>
      <section>
        ...
        >
          <div className="sm:h-[90vh] h-[80vh] overflow-y-auto  lg:w-3/6  md:w-4/6 w-5/6 mx-auto  rounded-lg"   style={{backgroundColor : '#fff' , box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;}}>
