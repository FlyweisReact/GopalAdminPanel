  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/admin/vendor-category/:id" element={<AdminVCategories />} />
        <Route path="/admin/vendor-dishes/:id" element={<AdminVDishes />} />
        <Route path="/admin/vendor-catering-service/:id" element={<AdminVCatering />} />
        <Route path="/admin/vendor-orders/:id" element={<AdminVOrders />} />
        <Route path="/admin/vendor-transaction/:id" element={<AdminVTransaction />} />
        <Route path="/admin/vendor-subscription/:id" element={<AdminVSubscription />} />
