...
const CouponsDiscount = () => {
  ...
  const Create = async (e) => {
    e.preventdefault()
    try { 
      const { data } = await axios.post("https://b7w3czz0m2.execute-api.ap-south-1.amazonaws.com/development/api/createcoupen")
    }catch(e) { 
      console.log(e)
    }
  }
      ...
      {show ? (
        ...
        >
          ...
          >
            ...
            <form style={{ padding: "20px" }} className='modalForm'> 
              <div className="mb-3">
